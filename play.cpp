...
namespace bullpgia {
	unsigned int play(Chooser& chooser, Guesser& guesser, unsigned int length, unsigned int maxTurns) {
		const unsigned int TECHNICAL_VICTORY_TO_GUESSER = 0;
		const unsigned int TECHNICAL_VICTORY_TO_CHOOSER = maxTurns+1;
